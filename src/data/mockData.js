...
export const INITIAL_ASSOCIATES = [
  {
    ...
    bio: "Passionate about building scalable AI tools for healthcare in Sub-Saharan Africa. Seeking guidance on career positioning, graduate school applications, and tech leadership.",
    skills: ["Python", "Machine Learning", "System Design", "Community Building"],
    careerGoal: "Lead AI Research & Development for health tech startups in Africa.",
  ...
  },
  {
    ...
    password: "password123",
    name: "Kofi Mensah",
    email: "kofi.mensah@ala.org",
    phone: "+234 80 312 9041",
    title: "Mastercard Foundation Associate",
    institution: "University of Toronto / African Leadership Academy",
    cohort: "2025-2026 Cohort",
    track: "Fintech & Financial Inclusion",
    bio: "Focusing on decentralized finance mechanisms and mobile money interoperability across West African markets.",
    skills: ["Fintech", "Financial Modeling", "Strategy", "Python"],
    careerGoal: "Founder of cross-border payment solutions for SME merchants.",
  ...
  },
  {
    ...
    password: "password123",
    name: "Zainab Hassan",
    email: "zainab.hassan@uct.ac.za",
    phone: "+27 61 992 4810",
    title: "Mastercard Foundation Public Health Scholar",
    institution: "University of Cape Town",
    cohort: "2024-2026 Cohort",
    track: "Public Health & Social Impact",
    bio: "Epidemiology research associate specializing in maternal health policy and data-driven disease intervention.",
    skills: ["Biostatistics", "R", "Policy Writing", "Grant Management"],
    careerGoal: "Senior Health Policy Advisor at WHO or African CDC.",
...
export const INITIAL_GROUP_SESSIONS = [
  {
    ...
    mentorAvatar: "/assets/mentor_samuel.jpg",
  ...
  },
  {
    ...
    mentorAvatar: "/assets/mentor_nia.jpg",
